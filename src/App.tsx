...
const fullEvents: Match[] = [
  { id: 'fe-1', match: 'WWE TRIPLE AAA - Full Shows in Order', event: 'Full Event', promotion: 'WWE', date: 'Various', rating: '0', videoId: 'PLlj3Hc_QGrSdOnoJnKeMOR7Rg2UK1HY0v', videoSource: 'youtube' },
  ...
  { id: 'fe-3', match: 'NXT Full Events', event: 'Full Event', promotion: 'WWE', date: 'Various', rating: '0', videoId: 'PLEpTCGDuJrIlSuw9dmXVmpqQX80CjN4aP', videoSource: 'youtube' },
