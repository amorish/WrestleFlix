...
WrestleFlix is a React-based web application that serves as a curated catalog for the greatest professional wrestling matches of all time. It provides users with a premium, modern interface to browse historical classics, highly-rated encounters (specifically focusing on Dave Meltzer's 5-star+ matches), and unforgettable experiences across major wrestling promotions like NJPW, WWE, AEW, and WCW.
...
* **Build Tool:** Vite
* **Styling:** Vanilla CSS with custom layouts & variables
* **Icons:** Lucide React
